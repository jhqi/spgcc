...
#pixel cnn encoding
cnn_encoding = np.load('/sd1/qjh/qjh_code/98_try/DataArray/SA_80.npy')

# prepare label
label_gt, labeled_p_in_sp = load_label(dataset_name, n_sp=n_sp)

#sp_map
sp_map = read_mat('/sd1/qjh/qjh_code/spgcc/sp_seg_map/SA_sp_map_2700.mat').astype(np.int32)
...
#superpixel adj
adj = np.load('/sd1/qjh/qjh_code/spgcc/sp_adj/SA_sp_adj_2700.npy')
adj = process_adj(adj)
adj = adj.to(device)
