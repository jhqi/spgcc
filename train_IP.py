...
param = {"n_sp": 1100, "lr": 1e-5, "threshold": 0.75, "temperature": 0.5, "alpha": 0.1, "dropout": 0.1}
...
# pixel cnn encoding
cnn_encoding = np.load("pretrained_emb/IP_pretrained_emb.npy")

# sp_map
sp_map = read_mat("sp_seg_map/IP_sp_map_1100.mat").astype(np.int32)
...
# superpixel adj
adj = np.load("sp_adj/IP_sp_adj_1100.npy")
adj = process_adj(adj)
adj = adj.to(device)
