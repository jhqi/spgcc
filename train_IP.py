...
#pixel cnn encoding
cnn_encoding = np.load('/sd1/qjh/qjh_code/98_try/DataArray/IP_35.npy')

#sp_map
sp_map = read_mat('/sd1/qjh/qjh_code/spgcc/sp_seg_map/IP_sp_map_1100.mat').astype(np.int32)
...
#superpixel adj
adj = np.load('/sd1/qjh/qjh_code/spgcc/sp_adj/IP_sp_adj_1100.npy')
adj = process_adj(adj)
adj = adj.to(device)
